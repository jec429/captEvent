void runTemplate(const char* file, int events=10, const char* options="") 
{
...
// writing a pizero analysis), copy "templateSelector.h" to "pizeroSelector.h",
// "templateSelector.C" to "pizeroSelector.C, and "runTemplate.C" to
// "runPizero.C".  Then so a global search and replace of "template" with
...
// print a lot of stuff in your analysis.
    ...
    t->Process("templateSelector.C+",options,events);
